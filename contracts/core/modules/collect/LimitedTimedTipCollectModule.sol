...
/**
 * @title LimitedTimedTipCollectModule
 ...
 */
contract LimitedTimedTipCollectModule is FeeModuleBase, FollowValidationModuleBase, ICollectModule {
     ...
     *      uint256 minAmount : The currency minimum amount to levy.
     ...
     *  4. Charging the fee that the user give
     */
    ...
    function _processCollect(
        ...
        _validateDataIsExpectedForTip(data, currency, _dataByPublicationByProfile[profileId][pubId].minAmount);
    ...
    function _processCollectWithReferral(
        ...
        IERC20(currency).safeTransferFrom(collector, _dataByPublicationByProfile[profileId][pubId].recipient, adjustedAmount);
        if (treasuryAmount > 0)
            IERC20(currency).safeTransferFrom(collector, treasury, treasuryAmount);
    }
